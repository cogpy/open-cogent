...
> Snapshot 1

    {
      ...
      * Remnote & Capacities with their object-based tag system␊
      ␊
      ␊
      For more details, please refer to our [RoadMap](https://docs.open-agent.io/docs/core-concepts/roadmap)␊
      ␊
      ␊
      ## Self Host␊
      ␊
      ...
      ␊
      ␊
      For developer or installation guides, please go to [AFFiNE Development](https://docs.open-agent.io/docs/development/quick-start)␊
      ␊
      ␊
      ␊
      ␊

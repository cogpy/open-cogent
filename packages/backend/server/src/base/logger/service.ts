...
export class OpenAgentLogger extends ConsoleLogger {
  ...
  override error(
    ...
    super.error(message, OpenAgentLogger.formatStack(stackOrError), context);
  }
}
